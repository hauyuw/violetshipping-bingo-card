...
window.SURVEY_QUESTIONS = [
  {
    ...
    options: [
      { id: 'q1o1',  text: 'Alternate Universe - Supernatural' },
      { id: 'q1o2',  text: 'Alternate Universe - No Millennium Items' },
      { id: 'q1o3',  text: 'Alternate Universe - Fantasy' },
      { id: 'q1o4',  text: 'Alternate Universe - Science Fiction' },
      { id: 'q1o5',  text: 'Alternate Universe - Historical Period' },
      { id: 'q1o6',  text: 'Crossover/Fusions' },
      { id: 'q1o7',  text: 'Pre-Canon' },
      { id: 'q1o8',  text: 'Season 0/Early Manga Continuity' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q4o10', text: 'Pre-slash/Pre-relationship' },
